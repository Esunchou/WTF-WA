...
MEETINGSTONE_UI_DB = {
	...
	["global"] = {
		["serverDatas"] = {
			...
			["ActivitiesData"] = {
				["data"] = "$1$Z$S300`魔兽主播活动`暗影将至`11月14日（周六）晚8点，快和斗鱼TV人气主播：棒老三（房间号：301049）共同体验暗影国度前瞻*J希尔瓦娜斯·风行者，部落的前任大酋长，她刺破了艾泽拉斯与亡者国度的帷幕，触发了一系列的事件，威胁到整个宇宙的生死平衡。勇士们，赶快与斗鱼TV主播一起，面对亡者国度的这些奇观和威胁，迎接新的冒险吧`http://w.163.com/special/convene-stone/`2`3$$",
			},
		},
		["spamWord"] = {
			{
