...
WeakAurasSaved = {
	...
	["displays"] = {
		...
		["狂徒六BUFF"] = {
			...
			["borderBackdrop"] = "Blizzard Tooltip",
			["xOffset"] = -33.83074951171875,
			["yOffset"] = -141.5000610351563,
			["anchorPoint"] = "CENTER",
			["borderColor"] = {
				0, -- [1]
				0, -- [2]
