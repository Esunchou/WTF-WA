	...
	["displays"] = {
		...
		["通用监控"] = {
			...
			["controlledChildren"] = {
				...
				"乱舞", -- [2]
				"切割下", -- [3]
				"Buff - Proc - O - Ruthless Precision - Yeluo 2", -- [4]
				"Buff - Proc - O - Broadside - Yeluo 2", -- [5]
				"Buff - Proc - O - Skull and Crossbones - Yeluo 2", -- [6]
				"Buff - Proc - O - Grand Melee - Yeluo 2", -- [7]
				"Buff - Proc - O - True Bearing - Yeluo 2", -- [8]
				"Buff - Proc - O - Buried Treasure - Yeluo 2", -- [9]
				"绿灯", -- [10]
				"黄灯", -- [11]
				"豆", -- [12]
				"诡诈", -- [13]
